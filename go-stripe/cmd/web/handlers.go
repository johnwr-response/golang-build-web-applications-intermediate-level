...
// VirtualTerminalReceipt shows the receipt page for virtual terminal
...
// OneUserByID shows one admin user for add/edit/delete
func (app *application) OneUserByID(w http.ResponseWriter, r *http.Request) {
